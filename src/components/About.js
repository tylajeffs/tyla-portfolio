...
function About() {
      ...
      case 50:
        return (
          <div>
            ...
            <p>
              To find out more about me, please check out my resumes down below.
              Have a great day, and may your code always compile and your divs
              stay centered! ☀️🫶
            </p>
          </div>
        );
        ...
        return (
          <div>
            ...
            <p>
              ...
              in software) and I’m happiest when I’m creating, exploring, and
              finding ways to make people’s lives easier.{" "}
            </p>
            <p>
              To find out more about me, please check out my resumes down below.
              Have a great day - however that looks for you - and may your code
              always compile and your divs stay centered! ☀️🫶
            </p>
          </div>
        );
      case 100:
        return (
          <div>
            ...
            <p>
              To find out more about me, please check out my resumes down below
              (fun or boring? Up to you!). Have a great day - however that looks
              for you - and may your code always compile and your divs stay
              centered! ☀️🫶
            </p>
          </div>
        );
  ...
  function renderBio(param) {
    return <div className="child">{selectBioLength(param)}</div>;
  }
  ...
  return (
    ...
    >
      ...
      <div className="contact-section">
        ...
        >
          <button className="about-button">tylajeffs@gmail.com</button>
        </a>
